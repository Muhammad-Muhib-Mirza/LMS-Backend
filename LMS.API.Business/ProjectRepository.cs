...
SELECT MAX(Tool_id) FROM Tools;
    ...
    ";
        ...
        private void UpdateAssociations<T>(SqlConnection conn, List<T> existingItems, List<long> newItems, string insertSql, string deleteSql, IDbTransaction transaction, DataManagementProperties dataManagementProperties, long projectId, string idField)
        {
