...
namespace LMS.Repository.Business
{
    public class UserRepository : IUserRepository
    {
        ...
        public UserDM Add(UserModel input)
        {
            ...
            using (SqlConnection conn = (SqlConnection)DBMSConnection.GetConnection(_config))
            {
        ...
        private long Add(UserDM input, SqlConnection conn, SqlTransaction transaction, DataManagementProperties dataManagementProperties, int expiryMinutes, int expiryMinutesPIN)
        {
        ...
        private bool AddAssesMe(AssesDM input, SqlConnection conn, SqlTransaction transaction, DataManagementProperties dataManagementProperties, int expiryMinutes, int expiryMinutesPIN)
        {
            bool result = false;
            try
            {
